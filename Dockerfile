FROM centos:7
RUN yum -y update
RUN yum install python3 xz-utils dbus-x11 x11-xserver-utils xorg gnome-system-monitor mate-system-monitor git xfce4 xfce4-goodies xfce4-terminal tigervnc-server curl wget -y
